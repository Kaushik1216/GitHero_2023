...
# Set up variables
password = ""
students = [("John", 1234,"123.4.5.6",93), ("Emily", 5678,"123.4.5.6",93), ("Mike", 9012,"123.4.5.6",93), ("Sara", 3456,"123.4.5.6",93), ("David", 7890,"123.4.5.6",93),
            ("Anna", 2345,"123.4.5.6",93), ("Tom", 6789,"123.4.5.6",93), ("Julia", 123,"123.4.5.6",93), ("Peter", 4567,"123.4.5.6",93), ("Mary", 8901,"123.4.5.6",93),
            ("Jake", 5432,"123.4.5.6",93), ("Olivia", 9876,"123.4.5.6",93), ("Nick", 3210,"123.4.5.6",93), ("Eva", 7654,"123.4.5.6",93), ("Sam", 1098,"123.4.5.6",93)]
student_texts = [font.render(f"{i+1}. {name}/{id}: {ip}", True, white) for i, (name, id,ip,attendance) in enumerate(students)]
is_logged_in = False
radius_1 = 100
radius_2 = 100
distance = 400
